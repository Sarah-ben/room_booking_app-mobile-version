...
import 'material_cubit/material_reservation_state.dart';

class materialReservationlistperuser extends StatelessWidget {
  materialReservationlistperuser(this.id);
  final id;
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<MaterialReservationCubit, MaterialReservationStates>(
              ...
              child: Container(
                ...
                child: ListView.separated(
                    itemBuilder: (context, index) => buildResItem(
                        MaterialReservationCubit.get(context).allReservationsByID[index],
                        context),
                    separatorBuilder: (context, index) => const Divider(),
                    itemCount:
                    MaterialReservationCubit.get(context).allReservationsByID.length),
              ),
            ),
          );
        },
...
Widget buildResItem(MaterialReservationData model, BuildContext context) => InkWell(
  child:
  Padding(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              deleteConfirmation(context, text1: 'this ID ${model.id_material}',function: ()=>ReservationCubit.get(context).deleteReservation(model.id, context));
